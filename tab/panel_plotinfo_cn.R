...
<li> <b>0 <=Cohen's Kappa 统计系数<0.4</b>；<b>较低的</b>可重复性 
...
p(tags$b("直方图")),
withSpinner(plotly::plotlyOutput(plot.id2, width = width),type = 1,proxy.height = 100),
p(br()),
...
p(tags$b("概率密度函数图")),
withSpinner(plotly::plotlyOutput(plot.id3, width = width),type = 1,proxy.height = 100),
