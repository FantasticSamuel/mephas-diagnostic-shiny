mod_server_10 <- function(id) {
  moduleServer(id, function(input, output, session) {
    result <- eventReactive(input$submit, {
      ...
      print(c(input$a1_null, input$b1_null, input$a2_null, input$b2_null, input$a1_alter, input$b1_alter, input$a2_alter, input$b2_alter, input$rD, input$rN, input$e1, input$e2, input$alpha, input$beta, input$R))
      samplepartialAUC(input$a1_null, input$b1_null, input$a2_null, input$b2_null, input$a1_alter, input$b1_alter, input$a2_alter, input$b2_alter, input$rD, input$rN, input$e1, input$e2, input$alpha, input$beta, input$R)
    })
